...
export class TranslationService {
  ...
  private fallbackTranslations: Record<Language, Translations> = {
    en: {
      ...
      'about.mainParagraph1': 'Founded in 2025, AMESA is a global-based startup addressing the need for trust and accessibility in online lotteries. Our core offering combines technology with regulatory compliance, making the platform both innovative and secure.',
      'about.mainParagraph2': 'AMESA points to break the world wide lotteries odds. Introducing best odds to win and fulfill your dream, by holding lotteries over properties and best location assets, While buying a lottery ticket for a minimum price, calculated by the asset value, rent and AI market analysis.',
      'about.mainParagraph3': 'AMESA was founded from the acknowledgement and our experience that buying a property is very hard and from time to time, maybe even seems impossible. Out of these harsh feelings, we decided to take up the gauntlet and introduce a first 4Wins model in the world, where everybody has a chance to win with an equivalent chance, best locations and fully paid (Tax, commissions, legal, etc).',
      'about.communityProfits': 'All of AMESA\'s profits will be used to help improve homelessness shelters, orphans shelters and animal shelters.',
