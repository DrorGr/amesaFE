...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-gray-800 transition-all duration-500 ease-in-out">
      ...
      <footer id="footer" role="contentinfo" class="bg-gradient-to-r from-gray-900 to-gray-800 dark:from-gray-950 dark:to-gray-900 text-white py-2 sm:py-5 md:py-8">
        <div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          <!-- Logo, Description and Social Media -->
          <div class="mb-1 sm:mb-3 md:mb-4 flex flex-col md:flex-row md:items-center md:justify-between gap-1.5 sm:gap-4 md:gap-6 mobile-footer-header">
            <div class="flex items-center gap-1.5 sm:gap-4 md:gap-6 mobile-footer-logo-section">
              <img 
            ...
            <!-- Social Media Links -->
            <div class="flex items-center space-x-1.5 sm:space-x-3 md:space-x-4 mobile-footer-social">
