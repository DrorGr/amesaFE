      ...
      <footer id="footer" role="contentinfo" class="bg-gradient-to-r from-gray-900 to-gray-800 dark:from-gray-950 dark:to-gray-900 text-white py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-3 sm:gap-4 md:gap-6 mb-4 sm:mb-6 mobile-footer-links">
            <!-- Community -->
            <div>
              <h4 class="font-semibold mb-2 sm:mb-3 text-white text-xs sm:text-sm md:text-base mobile-footer-section-heading">{{ translate('footer.community') }}</h4>
              <ul class="space-y-1 sm:space-y-2 text-gray-300 text-xs sm:text-sm mobile-footer-link-text">
            ...
            <!-- Support -->
            <div>
              <h4 class="font-semibold mb-2 sm:mb-3 text-white text-xs sm:text-sm md:text-base mobile-footer-section-heading">{{ translate('footer.support') }}</h4>
              <ul class="space-y-1 sm:space-y-2 text-gray-300 text-xs sm:text-sm mobile-footer-link-text">
            ...
            <!-- Legal -->
            <div>
              <h4 class="font-semibold mb-2 sm:mb-3 text-white text-xs sm:text-sm md:text-base mobile-footer-section-heading">{{ translate('footer.legal') }}</h4>
              <ul class="space-y-1 sm:space-y-2 text-gray-300 text-xs sm:text-sm mobile-footer-link-text">
                ...
                <!-- Legal Partners -->
                <div>
                  <h4 class="font-semibold mb-2 sm:mb-3 text-white text-xs sm:text-sm md:text-base mobile-footer-section-heading">{{ translate('footer.legalPartners') }}</h4>
                  <div class="space-y-2 sm:space-y-3">
                    <div>
                      <div class="text-gray-400 text-xs mb-1 mobile-footer-link-text">{{ translate('partners.legalPartner') }}</div>
                      <a href="https://ziebapartners.com" target="_blank" rel="noopener noreferrer" class="text-gray-300 hover:text-blue-400 transition-colors duration-200 hover:translate-x-1 transform inline-block text-xs sm:text-sm mobile-footer-link-text">
                        Zeiba & Partners
                      </a>
                    </div>
                    <div>
                      <div class="text-gray-400 text-xs mb-1 mobile-footer-link-text">{{ translate('partners.accountingPartner') }}</div>
                      <a href="https://pik.tax/kontakt" target="_blank" rel="noopener noreferrer" class="text-gray-300 hover:text-blue-400 transition-colors duration-200 hover:translate-x-1 transform block sm:inline-block text-xs sm:text-sm md:text-base break-words whitespace-normal mobile-footer-link-text">
            ...
            <!-- App Download -->
            <div>
              <h4 class="font-semibold mb-2 sm:mb-3 text-white text-xs sm:text-sm md:text-base mobile-footer-section-heading">{{ translate('footer.comingSoon') }}</h4>
              <div class="flex flex-col space-y-1.5 sm:space-y-2">
                <div class="bg-gray-600 rounded-lg px-3 sm:px-4 py-2 sm:py-3 flex items-center space-x-2 sm:space-x-3 opacity-60 cursor-not-allowed">
                  ...
                  <div class="text-left">
                    ...
                    <div class="text-xs sm:text-sm font-semibold text-white">App Store</div>
                  </div>
                </div>
                <div class="bg-gray-600 rounded-lg px-3 sm:px-4 py-2 sm:py-3 flex items-center space-x-2 sm:space-x-3 opacity-60 cursor-not-allowed">
                  <svg class="w-6 h-6 sm:w-8 sm:h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div class="text-left">
                    <div class="text-xs text-gray-300">Coming soon on</div>
                    <div class="text-xs sm:text-sm font-semibold text-white">Google Play</div>
                  </div>
                </div>
              </div>
            </div>
