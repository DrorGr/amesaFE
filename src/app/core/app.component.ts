    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-gray-800 transition-all duration-500 ease-in-out">
      ...
      <footer id="footer" role="contentinfo" class="bg-gradient-to-r from-gray-900 to-gray-800 dark:from-gray-950 dark:to-gray-900 text-white py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <!-- Footer Links Grid -->
          <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4 md:gap-6 mb-6 mobile-footer-links">
            <!-- Community -->
            <div>
                ...
                <div>
                  ...
                  <div class="space-y-3">
                    ...
                    <div>
                      ...
                      <a href="https://pik.tax/kontakt" target="_blank" rel="noopener noreferrer" class="text-gray-300 hover:text-blue-400 transition-colors duration-200 hover:translate-x-1 transform block sm:inline-block text-sm sm:text-base break-words whitespace-normal mobile-footer-link-text">
