        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-2 sm:gap-3 md:gap-6 mb-2 sm:mb-4 md:mb-6 mobile-footer-links">
            ...
            <div>
              ...
              <ul class="space-y-0.5 sm:space-y-1 md:space-y-2 text-gray-300 text-[10px] sm:text-xs md:text-sm mobile-footer-link-text">
            ...
            <!-- Support -->
            <div>
              <h4 class="font-semibold mb-1.5 sm:mb-2 md:mb-3 text-white text-[10px] sm:text-xs md:text-sm lg:text-base mobile-footer-section-heading">{{ translate('footer.support') }}</h4>
              <ul class="space-y-0.5 sm:space-y-1 md:space-y-2 text-gray-300 text-[10px] sm:text-xs md:text-sm mobile-footer-link-text">
            ...
            <!-- Legal -->
            <div>
              <h4 class="font-semibold mb-1.5 sm:mb-2 md:mb-3 text-white text-[10px] sm:text-xs md:text-sm lg:text-base mobile-footer-section-heading">{{ translate('footer.legal') }}</h4>
              <ul class="space-y-0.5 sm:space-y-1 md:space-y-2 text-gray-300 text-[10px] sm:text-xs md:text-sm mobile-footer-link-text">
                ...
                <!-- Legal Partners -->
                <div>
                  <h4 class="font-semibold mb-1.5 sm:mb-2 md:mb-3 text-white text-[10px] sm:text-xs md:text-sm lg:text-base mobile-footer-section-heading">{{ translate('footer.legalPartners') }}</h4>
                  <div class="space-y-1.5 sm:space-y-2 md:space-y-3">
                    <div>
                      <div class="text-gray-400 text-[10px] sm:text-xs mb-0.5 sm:mb-1 mobile-footer-link-text">{{ translate('partners.legalPartner') }}</div>
                    ...
                    <div>
                      <div class="text-gray-400 text-[10px] sm:text-xs mb-0.5 sm:mb-1 mobile-footer-link-text">{{ translate('partners.accountingPartner') }}</div>
            ...
            <!-- App Download -->
            <div>
              <h4 class="font-semibold mb-1.5 sm:mb-2 md:mb-3 text-white text-[10px] sm:text-xs md:text-sm lg:text-base mobile-footer-section-heading">{{ translate('footer.comingSoon') }}</h4>
              <div class="flex flex-col space-y-1 sm:space-y-1.5 md:space-y-2">
                <div class="bg-gray-600 rounded-lg px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 md:py-3 flex items-center space-x-1.5 sm:space-x-2 md:space-x-3 opacity-60 cursor-not-allowed">
