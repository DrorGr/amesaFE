          ...
          <div class="max-w-2xl mx-auto">
            <div class="relative">
              <input
                ...
                class="w-full px-6 py-4 pl-12 text-2xl border border-gray-300 dark:border-gray-600 rounded-xl focus:border-transparent transition-all duration-200 bg-white dark:bg-gray-700 text-gray-900 dark:text-white shadow-lg">
