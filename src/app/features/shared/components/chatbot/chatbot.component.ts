  ...
  template: `
    ...
    @if (!isHidden()) {
      <div class="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 flex flex-col items-end">
        ...
        <!-- Chat Window -->
        @if (isOpen()) {
          <div class="mb-4 w-[90vw] max-w-80 md:w-96 h-96 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 flex flex-col overflow-hidden animate-slide-up">
            ...
            <div class="p-4 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
              <div class="flex space-x-2">
                <input
                  ...
                  class="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 text-sm"
                  [disabled]="isTyping()">
                <button
                  (click)="sendMessage()"
...
export class ChatbotComponent {
  ...
  hideWidget() {
    ...
    console.log('Chatbot widget hidden for current session');
  }
  
  showWidget() {
    this.isHidden.set(false);
    console.log('Chatbot widget shown');
  }
