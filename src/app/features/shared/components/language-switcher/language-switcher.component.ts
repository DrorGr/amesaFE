...
import { TranslationService, Language, LanguageInfo } from '@core/services/translation.service';
  ...
  template: `
    <div class="relative">
      <button
        ...
        <span class="text-black dark:text-white font-bold text-sm">{{ getCurrentLanguageCode() }}</span>
