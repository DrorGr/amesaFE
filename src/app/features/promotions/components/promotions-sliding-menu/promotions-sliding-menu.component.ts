...
import { PromotionService, PromotionDto } from '../../../payment/services/promotion.service';
...
@Component({
  ...
  template: `
    @if (isOpen()) {
      ...
      <!-- Menu -->
      <div 
        class="fixed left-0 top-0 h-full w-[85vw] max-w-80 md:w-96 bg-white dark:bg-gray-900 shadow-xl z-[110] transform transition-transform duration-300 ease-in-out" 
