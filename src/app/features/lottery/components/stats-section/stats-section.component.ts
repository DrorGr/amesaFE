...
@Component({
  ...
  template: `
    <section class="relative py-4 md:py-24 overflow-hidden" aria-labelledby="stats-section-title">
      <!-- Vibrant Background -->
      ...
      <div class="relative w-full overflow-hidden">
          ...
          <div class="flex animate-infinite-scroll space-x-12 md:space-x-16 lg:space-x-20 py-2 md:py-8 px-4">
            <!-- First Set -->
            @for (stat of stats; track stat.labelKey + '-1') {
              <div class="flex-shrink-0 min-w-[180px] md:min-w-[220px] lg:min-w-[280px]">
                <div class="group text-center">
                  <!-- Vibrant Stat Card -->
                  <div class="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-xl md:rounded-2xl p-3 md:p-8 shadow-lg hover:shadow-xl transition-all duration-700 ease-out border border-blue-100/50 dark:border-gray-700/50 group-hover:border-blue-300/70 dark:group-hover:border-blue-600/70 group-hover:bg-white dark:group-hover:bg-gray-800"
                       role="article"
                       [attr.aria-label]="getStatLabel(stat.labelKey) + ': ' + stat.value">
                    
                    <!-- Large Number -->
                    <div class="text-xl md:text-4xl lg:text-5xl font-black text-slate-800 dark:text-white mb-1 md:mb-4 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-500 ease-out"
                         [attr.aria-label]="'Value: ' + stat.value">
                      {{ stat.value }}
                    </div>
                    
                    <!-- Icon -->
                    <div class="text-lg md:text-3xl mb-1 md:mb-4 opacity-70 group-hover:opacity-100 transition-all duration-600 ease-out group-hover:scale-105 transform"
                    ...
                    <!-- Label -->
                    <div class="text-slate-600 dark:text-gray-300 font-semibold text-xs md:text-base leading-tight group-hover:text-slate-800 dark:group-hover:text-gray-100 transition-colors duration-500 ease-out">
