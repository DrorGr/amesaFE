...
} from '@core/interfaces/lottery.interface';
import {
  LotteryParticipantStats,
  CanEnterLotteryResponse
} from '@core/interfaces/watchlist.interface';
import { RealtimeService, FavoriteUpdateEvent, EntryStatusChangeEvent, DrawReminderEvent, RecommendationEvent, InventoryUpdateEvent, CountdownUpdateEvent } from '@core/services/realtime.service';
