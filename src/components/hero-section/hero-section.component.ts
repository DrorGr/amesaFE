      ...
      <div class="bg-white dark:bg-gray-900 py-16 transition-colors duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="relative max-w-4xl mx-auto">
            <!-- Content Area -->
            <div class="bg-gray-50 dark:bg-gray-800 rounded-2xl p-8 shadow-lg min-h-[400px] flex items-center justify-center overflow-hidden">
              <div class="w-full h-full flex flex-col">
                <!-- House Title -->
                ...
                <div class="flex items-center justify-center space-x-4">
                  ...
                  <button 
                    (click)="previousHouseImage()"
                    class="w-10 h-10 bg-gray-200 dark:bg-gray-700 rounded-full shadow hover:shadow-md transition-all duration-200 flex items-center justify-center text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">
