  ...
  template: `
    <div class="relative">
      <button
        ...
        class="flex items-center space-x-1 md:space-x-2 px-2 md:px-3 py-2 text-xs md:text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200">
