...
export class AccessibilityWidgetComponent {
  ...
  hideWidget() {
    ...
    if (typeof localStorage !== 'undefined') {
      localStorage.setItem('amesa-accessibility-widget-hidden', 'true');
    }
  }
  ...
  showWidget() {
    ...
    if (typeof localStorage !== 'undefined') {
      localStorage.removeItem('amesa-accessibility-widget-hidden');
    }
  }
  ...
  loadHiddenState() {
    if (typeof localStorage !== 'undefined') {
      const hidden = localStorage.getItem('amesa-accessibility-widget-hidden');
      if (hidden === 'true') {
        this.isHidden.set(true);
      }
    }
